    ...
    <header className="header bg-natural text-natural-content flex justify-items-start place-content-around items-center mx-auto px-8 py-3 top-0 w-full z-50">
      ...
      <nav className="flex h-14 mx-auto w-full items-center justify-between">
        <ul className="flex space-x-4">
          <li>
            <Link href="/" className="text-xl text-natural-content hover:font-bold">
              Home
            </Link>
          </li>
          <li>
            <Link href="/profil" className="text-xl text-natural-content hover:font-bold">
              Profil
            </Link>
          </li>
          <li>
            <Link href="/akun" className="text-xl text-natural-content hover:font-bold">
              Manajemen Akun
            </Link>
          </li>
          <li>
            <Link href="/laporan" className="text-xl text-natural-content hover:font-bold">
              Laporan
            </Link>
          </li>
        </ul>
